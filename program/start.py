        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "Source Channel ", url=f"https://t.me/{UPDATES_CHANNEL}"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "Exp Source", url="https://t.me/o_www"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("Source Channel ", url=f"https://t.me/nnn_e"),
                InlineKeyboardButton(
                    "Exp Source ", url=f"https://t.me/o_www"
                ),
            ]
        ]
    )
